...
def main(args):
    ...
    for tf in FILENAME:
        ...
        #
        # Log BATCH_ID to process 
        #
        ###logging.info(' | Logging incremental BATCH_ID for each script to be processed: %s' %(batchid))
        ...
        logging.info(' | Transform below, called to execute:')
        ...
        #
        # Execute query_string from transform file, as cursor
        #            
        try:
